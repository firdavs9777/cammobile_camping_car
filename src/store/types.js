...
// Getter 
export const CHANGE_TO_TRUE = 'menuToggle/CHANGE_TO_TRUE';
export const BOOLEAN_VALUE = 'shared/BOOLEAN_VALUE';

// Mutation 
export const MUTATE_BOOLEAN = 'menuToggle/MUTATE_BOOLEAN';
export const MUTATE_UPDATE_BOOLEAN = 'shared/MUTATE_UPDATE_BOOLEAN';

// Action 
export const COUNTER_BOOLEAN = 'menuToggle/COUNTER_BOOLEAN';
export const UPDATE_COUNTER_BOOLEAN = 'shared/UPDATE_COUNTER_BOOLEAN';
